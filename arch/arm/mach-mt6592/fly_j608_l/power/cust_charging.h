...
#define MAX_CHARGE_TEMPERATURE_MINUS_X_DEGREE	48    //zhaofeng lenovo
#define MIN_CHARGE_TEMPERATURE  1		//zhaofeng lenovo
#define MIN_CHARGE_TEMPERATURE_PLUS_X_DEGREE	2    //zhaofeng lenovo
...
#define AC_CHARGER_CURRENT					CHARGE_CURRENT_850_00_MA//modify by youweiqiang 2014.06.12
...
/* charger error check */
#define BAT_LOW_TEMP_PROTECT_ENABLE     //youweiqiang   // stop charging if temp < MIN_CHARGE_TEMPERATURE
#define V_CHARGER_ENABLE 0				// 1:ON , 0:OFF	
#define V_CHARGER_MAX 6300				// 6.3 V  changed by caozhengguang
