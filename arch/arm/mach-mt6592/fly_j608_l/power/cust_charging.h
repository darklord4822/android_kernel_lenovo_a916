...
/* caodongwei START */
// >= 50 degree or <= 0 degree then STOP charge
/* maximum and minimum charger temperature recovered from error state */
// <= 45 or >= 3 then charge continued
...
#define HIGH_BATTERY_VOLTAGE_SUPPORT
    ...
    #define    HIGH_BATTERY_OVER_VOLTAGE        4380
#else
    #define    NORMAL_BATTERY_OVER_VOLTAGE      4250
#endif
    ...
    #define CHARGING_FULL_CURRENT       180
#else
    /* Linear Charging Threshold */
...
#define USB_CHARGER_CURRENT_CONFIGURED	CHARGE_CURRENT_550_00_MA	// 550mA

#define USB_CHARGER_CURRENT                 CHARGE_CURRENT_550_00_MA	//550mA
#define AC_CHARGER_CURRENT		         CHARGE_CURRENT_950_00_MA
#define NON_STD_AC_CHARGER_CURRENT		 AC_CHARGER_CURRENT
#define CHARGING_HOST_CHARGER_CURRENT       CHARGE_CURRENT_950_00_MA
#define APPLE_0_5A_CHARGER_CURRENT          CHARGE_CURRENT_550_00_MA
#define APPLE_1_0A_CHARGER_CURRENT          CHARGE_CURRENT_950_00_MA
#define APPLE_2_1A_CHARGER_CURRENT          CHARGE_CURRENT_950_00_MA
...
/* charger error check */
//lisong 2014-3-25 [NO BUGID][enable charging protect in low temperature]start
//#define BAT_LOW_TEMP_PROTECT_ENABLE         // stop charging if temp < MIN_CHARGE_TEMPERATURE
#define BAT_LOW_TEMP_PROTECT_ENABLE         // stop charging if temp < MIN_CHARGE_TEMPERATURE
//lisong 2014-3-25 [NO BUGID][enable charging protect in low temperature]end
#define V_CHARGER_ENABLE 0				// the switch for V_CHARGER_MIN: 1:ON , 0:OFF	
