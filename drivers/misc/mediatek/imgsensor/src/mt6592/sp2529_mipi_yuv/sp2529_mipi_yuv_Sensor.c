...
#endif
  //saturation
#define SP2529_P1_Reg0xd3  0x8d
#define SP2529_P1_Reg0xd4  0x90
#define SP2529_P1_Reg0xd5  0x82
#define SP2529_P1_Reg0xd6  0x70
#define SP2529_P1_Reg0xd7  0x8d
#define SP2529_P1_Reg0xd8  0x90
#define SP2529_P1_Reg0xd9  0x82
#define SP2529_P1_Reg0xda  0x70
//contrast
#define SP2529_P1_Reg0x10  0x80
#define SP2529_P1_Reg0x11  0x80
#define SP2529_P1_Reg0x12  0x80
#define SP2529_P1_Reg0x13  0x80
#define SP2529_P1_Reg0x14  0x94
#define SP2529_P1_Reg0x15  0x94
#define SP2529_P1_Reg0x16  0x94
#define SP2529_P1_Reg0x17  0x94
//exposure
#define SP2529_P1_Reg0xeb  0x7c
#define SP2529_P1_Reg0xec  0x7c
...
int SP2529_SEN_RUN_TEST_PATTERN = 0;
#define SP2529_TEST_PATTERN_CHECKSUM 0x63ca3f5a
...
static DEFINE_SPINLOCK(SP2529mipi_yuv_drv_lock);
...
{
  spin_lock(&SP2529mipi_yuv_drv_lock);
  ...
  SP2529MIPICurrentStatus.isaturation = ISP_SAT_MIDDLE;
  SP2529MIPICurrentStatus.icontrast = ISP_CONTRAST_MIDDLE;
  SP2529MIPICurrentStatus.ibrightness = ISP_BRIGHT_MIDDLE;
  spin_unlock(&SP2529mipi_yuv_drv_lock);
}
...
//binning 800 600
 ...
 SP2529MIPI_write_cmos_sensor(0x30,0x00);
 SP2529MIPI_write_cmos_sensor(0x31,0x04);
 SP2529MIPI_write_cmos_sensor(0x33,0x01);
 SP2529MIPI_write_cmos_sensor(0x2f,0x09);//pll 2
         
 SP2529MIPI_write_cmos_sensor(0x1d,0x00);
 SP2529MIPI_write_cmos_sensor(0x1b,0x37);
        
 SP2529MIPI_write_cmos_sensor(0x0c,0x66);
 SP2529MIPI_write_cmos_sensor(0x27,0xa5);
 SP2529MIPI_write_cmos_sensor(0x28,0x08);
 SP2529MIPI_write_cmos_sensor(0x1d,0x01);
 SP2529MIPI_write_cmos_sensor(0x1e,0x13);
 SP2529MIPI_write_cmos_sensor(0x21,0x10);
 SP2529MIPI_write_cmos_sensor(0x15,0x16);
 SP2529MIPI_write_cmos_sensor(0x71,0x18);   
 SP2529MIPI_write_cmos_sensor(0x7c,0x18);  
 SP2529MIPI_write_cmos_sensor(0x76,0x19);
//MIPI     
 ...
 SP2529MIPI_write_cmos_sensor(0x98,0x39);

 SP2529MIPI_write_cmos_sensor(0xfd,0x02);
 SP2529MIPI_write_cmos_sensor(0x85,0x00);
#if 1
SP2529MIPI_write_cmos_sensor(0xfd,0x00);
SP2529MIPI_write_cmos_sensor(0x2f,0x09);//pll 1.5
 /*capture normal mode 1.5pll 10-15fps 50hz*/
 //luo-0924
 SP2529MIPI_write_cmos_sensor(0xfd,0x00);
...
#else
 SP2529MIPI_write_cmos_sensor(0xfd,0x00);
 SP2529MIPI_write_cmos_sensor(0x2f,0x04);//pll 2
//ae setting fix 30fps
 SP2529MIPI_write_cmos_sensor(0xfd,0x00);
 SP2529MIPI_write_cmos_sensor(0x03,0x08);
 SP2529MIPI_write_cmos_sensor(0x04,0xb8);
 SP2529MIPI_write_cmos_sensor(0x05,0x00);
 SP2529MIPI_write_cmos_sensor(0x06,0x00);
 SP2529MIPI_write_cmos_sensor(0x07,0x00);
 SP2529MIPI_write_cmos_sensor(0x08,0x00);
 SP2529MIPI_write_cmos_sensor(0x09,0x00);
 SP2529MIPI_write_cmos_sensor(0x0a,0x80);
 SP2529MIPI_write_cmos_sensor(0xfd,0x01);
 SP2529MIPI_write_cmos_sensor(0xf0,0x11);
 SP2529MIPI_write_cmos_sensor(0xf7,0x74);
 SP2529MIPI_write_cmos_sensor(0xf8,0x36);
 SP2529MIPI_write_cmos_sensor(0x02,0x03);
 SP2529MIPI_write_cmos_sensor(0x03,0x01);
 SP2529MIPI_write_cmos_sensor(0x06,0x74);
 SP2529MIPI_write_cmos_sensor(0x07,0x01);
 SP2529MIPI_write_cmos_sensor(0x08,0x01);
 SP2529MIPI_write_cmos_sensor(0x09,0x00);
 SP2529MIPI_write_cmos_sensor(0xfd,0x02);
 SP2529MIPI_write_cmos_sensor(0x3d,0x04);
 SP2529MIPI_write_cmos_sensor(0x3e,0x36);
 SP2529MIPI_write_cmos_sensor(0x3f,0x01);
 SP2529MIPI_write_cmos_sensor(0x88,0x60);
 SP2529MIPI_write_cmos_sensor(0x89,0xa6);
 SP2529MIPI_write_cmos_sensor(0x8a,0x94);
 SP2529MIPI_write_cmos_sensor(0xfd,0x02);
 ...
 SP2529MIPI_write_cmos_sensor(0xb9,0xa0);  //mean_dummy_nr                                                                     
 SP2529MIPI_write_cmos_sensor(0xba,0x30);  //mean_dummy_low                                                                    
 SP2529MIPI_write_cmos_sensor(0xbb,0x45);  //mean_low_dummy                                                                    
 SP2529MIPI_write_cmos_sensor(0xbc,0x90);  //rpc_heq_low                                                                       
 SP2529MIPI_write_cmos_sensor(0xbd,0x50);  //rpc_heq_dummy                                                                     
 SP2529MIPI_write_cmos_sensor(0xfd,0x03);                                                                                     
 SP2529MIPI_write_cmos_sensor(0x77,0x50);	 //rpc_heq_nr2                                                                     
...
//rpc                                                                                             
 ...
 SP2529MIPI_write_cmos_sensor(0x04,0xa0);  //rpc_max_indr                                                                      
 SP2529MIPI_write_cmos_sensor(0x05,0x26);//2c  //rpc_min_indr                                                                   
 SP2529MIPI_write_cmos_sensor(0x0a,0x48);  //rpc_max_outdr                                                                     
 SP2529MIPI_write_cmos_sensor(0x0b,0x26);//2c  //rpc_min_outdr                                                                     
                                                                                       
                                                                                       
 SP2529MIPI_write_cmos_sensor(0xfd,0x01);  //ae target                                                                         
 SP2529MIPI_write_cmos_sensor(0xeb,0x7a);  //target_indr		                                                          
 SP2529MIPI_write_cmos_sensor(0xec,0x7a);  //target_outdr		                                                          
 SP2529MIPI_write_cmos_sensor(0xed,0x05);  //lock_range                                                                        
...
//去坏像素
 ...
 SP2529MIPI_write_cmos_sensor(0x94,0x20);//dpix_wht_ofst_normal2
 ...
 SP2529MIPI_write_cmos_sensor(0x95,0x80);//dpix_blk_ofst_normal2
 ...
 SP2529MIPI_write_cmos_sensor(0x96,0x68);//dpix_wht/blk_ratio_nr2
...
//lsc                                                                                           
 ...
 SP2529MIPI_write_cmos_sensor(0x29,0x20);  //lsc_dec_fac                                                                       
 SP2529MIPI_write_cmos_sensor(0x2a,0x01);  //lsc_rpc_en lens衰减自适应                                                         
                                                                                      
//霸王lens              
  SP2529MIPI_write_cmos_sensor(0xfd,0x01);                                                                     
  SP2529MIPI_write_cmos_sensor(0xa1,0x1b);                                                                     
  SP2529MIPI_write_cmos_sensor(0xa2,0x1d);                                                                  
  SP2529MIPI_write_cmos_sensor(0xa3,0x1a);                                                                     
  SP2529MIPI_write_cmos_sensor(0xa4,0x1a);                                                                     
  SP2529MIPI_write_cmos_sensor(0xa5,0x16);                                                                  
  SP2529MIPI_write_cmos_sensor(0xa6,0x16);                                                                     
  SP2529MIPI_write_cmos_sensor(0xa7,0x15);                                                                     
  SP2529MIPI_write_cmos_sensor(0xa8,0x12);                                                                     
  SP2529MIPI_write_cmos_sensor(0xa9,0x11);                                                                  
  SP2529MIPI_write_cmos_sensor(0xaa,0x11);                                                                  
  SP2529MIPI_write_cmos_sensor(0xab,0x10);                                                                     
  SP2529MIPI_write_cmos_sensor(0xac,0x11);                                                                     
  SP2529MIPI_write_cmos_sensor(0xad,0x06);                                                                  
  SP2529MIPI_write_cmos_sensor(0xae,0x0b);                                                                     
  SP2529MIPI_write_cmos_sensor(0xaf,0x05);                                                                     
  SP2529MIPI_write_cmos_sensor(0xb0,0x11);                                                                      
  SP2529MIPI_write_cmos_sensor(0xb1,0x09);                                                                   
  SP2529MIPI_write_cmos_sensor(0xb2,0x06);                                                                   
  SP2529MIPI_write_cmos_sensor(0xb3,0x03);                                                                      
  SP2529MIPI_write_cmos_sensor(0xb4,0x11);                                                                      
  SP2529MIPI_write_cmos_sensor(0xb5,0x08);                                                                   
  SP2529MIPI_write_cmos_sensor(0xb6,0x08);                                                                      
  SP2529MIPI_write_cmos_sensor(0xb7,0x04);                                                                      
  SP2529MIPI_write_cmos_sensor(0xb8,0x0d);                                                                   
                                                                              
//AWB                                                                                        
 SP2529MIPI_write_cmos_sensor(0xfd,0x02);                                                                                     
 SP2529MIPI_write_cmos_sensor(0x26,0xac); //Red channel gain                                                                   
 ...
 SP2529MIPI_write_cmos_sensor(0x11,0x20);
                                                                                        
//d65 88                                                                                 
 SP2529MIPI_write_cmos_sensor(0x66,0x36);                                                                              
 SP2529MIPI_write_cmos_sensor(0x67,0x64);                                                                              
 SP2529MIPI_write_cmos_sensor(0x68,0xb1);                                                                              
 SP2529MIPI_write_cmos_sensor(0x69,0xdf);                                                                              
 SP2529MIPI_write_cmos_sensor(0x6a,0xa5);                                                                              
                                                                                      
 //indoor                                                                                       
 SP2529MIPI_write_cmos_sensor(0x7c,0x2b);                                                                                 
 SP2529MIPI_write_cmos_sensor(0x7d,0x51);                                                                               
 SP2529MIPI_write_cmos_sensor(0x7e,0xe0);                                                                         
 SP2529MIPI_write_cmos_sensor(0x7f,0x00);                                                                                     
 SP2529MIPI_write_cmos_sensor(0x80,0xa6);                                                                                     
                                                                                    
//cwf                                                                                    
 SP2529MIPI_write_cmos_sensor(0x70,0x26);                                                                             
 SP2529MIPI_write_cmos_sensor(0x71,0x47);                                                                             
 SP2529MIPI_write_cmos_sensor(0x72,0x00);                                                                             
 SP2529MIPI_write_cmos_sensor(0x73,0x1f);                                                                             
 SP2529MIPI_write_cmos_sensor(0x74,0xaa);                                                                             
                                                                             
 //tl84                                                                                 
 SP2529MIPI_write_cmos_sensor(0x6b,0x00);                                                                             
 SP2529MIPI_write_cmos_sensor(0x6c,0x25);                                                                             
 SP2529MIPI_write_cmos_sensor(0x6d,0x20);                                                                             
 SP2529MIPI_write_cmos_sensor(0x6e,0x40);                                                                             
 SP2529MIPI_write_cmos_sensor(0x6f,0xaa);                                                                             
                                                                             
 //f                                                                                        
 SP2529MIPI_write_cmos_sensor(0x61,0xf7);                                                                             
 SP2529MIPI_write_cmos_sensor(0x62,0x25);                                                                             
 SP2529MIPI_write_cmos_sensor(0x63,0x1b);                                                                             
 SP2529MIPI_write_cmos_sensor(0x64,0x49);                                                                             
 ...
 SP2529MIPI_write_cmos_sensor(0x3b,0x09);//awb                                                                                 
...
//skin detect                                                                                    
 ...
 SP2529MIPI_write_cmos_sensor(0x57,0x2a);  //raw_sharp_y_base                                                                  
 SP2529MIPI_write_cmos_sensor(0x58,0x10);  //raw_sharp_y_min                                                                   
 SP2529MIPI_write_cmos_sensor(0x59,0xe0);  //raw_sharp_y_max                                                                   
 SP2529MIPI_write_cmos_sensor(0x5a,0x20);//30  //raw_sharp_rangek_neg                                                           
 SP2529MIPI_write_cmos_sensor(0x5b,0x20);  //raw_sharp_rangek_pos                                                              
                                                                                       
 SP2529MIPI_write_cmos_sensor(0xcb,0x0a);//18	 //raw_sharp_range_base_outdoor	                                          
 SP2529MIPI_write_cmos_sensor(0xcc,0x0a);//18	 //raw_sharp_range_base_nr 	                                          
 SP2529MIPI_write_cmos_sensor(0xcd,0x20);//18	 //raw_sharp_range_base_dummy	                                          
 SP2529MIPI_write_cmos_sensor(0xce,0x70);//18	 //raw_sharp_range_base_low	                                          
                                                                                       
 SP2529MIPI_write_cmos_sensor(0xfd,0x03);                                                                                     
 SP2529MIPI_write_cmos_sensor(0x87,0x0a);			//raw_sharp_range_ofst1	4x                                        
 SP2529MIPI_write_cmos_sensor(0x88,0x14);			//raw_sharp_range_ofst2	8x                                        
 SP2529MIPI_write_cmos_sensor(0x89,0x18);			//raw_sharp_range_ofst3	16x                                       
                                                                                       
 SP2529MIPI_write_cmos_sensor(0xfd,0x02);                                                                                     
 SP2529MIPI_write_cmos_sensor(0xe8,0x30);   //sharpness gain for increasing pixel’s Y, in outdoor                             
 SP2529MIPI_write_cmos_sensor(0xec,0x40);   //sharpness gain for decreasing pixel’s Y, in outdoor                             
 SP2529MIPI_write_cmos_sensor(0xe9,0x30);//38   //sharpness gain for increasing pixel’s Y, in normal                           
 SP2529MIPI_write_cmos_sensor(0xed,0x40);//40   //sharpness gain for decreasing pixel’s Y, in normal                           
 SP2529MIPI_write_cmos_sensor(0xea,0x28);   //sharpness gain for increasing pixel’s Y,in dummy                                
 SP2529MIPI_write_cmos_sensor(0xee,0x38);   //sharpness gain for decreasing pixel’s Y, in dummy                               
 SP2529MIPI_write_cmos_sensor(0xeb,0x20);   //sharpness gain for increasing pixel’s Y,in lowlight                             
 SP2529MIPI_write_cmos_sensor(0xef,0x30);   //sharpness gain for decreasing pixel’s Y, in low light                           
                                                                                      
 SP2529MIPI_write_cmos_sensor(0xfd,0x02);		//skin sharpen                                                             
 SP2529MIPI_write_cmos_sensor(0xdc,0x03);		//skin_sharp_sel肤色降锐化                                                 
...
//平滑自适应                                                                                       
 ...
 SP2529MIPI_write_cmos_sensor(0xfd,0x02);                                                                                     
 SP2529MIPI_write_cmos_sensor(0xe4,0xff);//40 //raw_yk_fac_outdoor                                                              
 SP2529MIPI_write_cmos_sensor(0xe5,0xff);//40 //raw_yk_fac_normal                                                               
 SP2529MIPI_write_cmos_sensor(0xe6,0xff);//40 //raw_yk_fac_dummy                                                                
 SP2529MIPI_write_cmos_sensor(0xe7,0xff);//40 //raw_yk_fac_low                                                                  
                                                                                       
 SP2529MIPI_write_cmos_sensor(0xfd,0x03);                                                                                     
 SP2529MIPI_write_cmos_sensor(0x72,0x00);  //raw_lsc_fac_outdoor                                                               
 SP2529MIPI_write_cmos_sensor(0x73,0x2d);  //raw_lsc_fac_normal                                                                
 SP2529MIPI_write_cmos_sensor(0x74,0x2d);  //raw_lsc_fac_dummy                                                                 
 SP2529MIPI_write_cmos_sensor(0x75,0x2d);  //raw_lsc_fac_low                                                                   
                                                                                                 
//四个通道内阈值                                                                                   
 SP2529MIPI_write_cmos_sensor(0xfd,0x02); //raw_dif_thr                                                                        
 SP2529MIPI_write_cmos_sensor(0x78,0x40); //raw_dif_thr_outdoor                                                                
 SP2529MIPI_write_cmos_sensor(0x79,0x40);//0a                                                                                  
 SP2529MIPI_write_cmos_sensor(0x7a,0x14);//10                                                                                  
 SP2529MIPI_write_cmos_sensor(0x7b,0x08);//20                                                                                  
                                                                                             
//Gr、Gb通道);阈值                                                                                  
 SP2529MIPI_write_cmos_sensor(0x81,0x20); //10//raw_grgb_thr_outdoor                                                            
 SP2529MIPI_write_cmos_sensor(0x82,0x20); //10                                                                                 
 SP2529MIPI_write_cmos_sensor(0x83,0x14); //10                                                                                 
 SP2529MIPI_write_cmos_sensor(0x84,0x08); //10                                                                                 
                                                                                             
 SP2529MIPI_write_cmos_sensor(0xfd,0x03);                                                                                     
 SP2529MIPI_write_cmos_sensor(0x7e,0x08);     //raw_noise_base_outdoor                                                         
 SP2529MIPI_write_cmos_sensor(0x7f,0x10);     //raw_noise_base_normal                                                          
 SP2529MIPI_write_cmos_sensor(0x80,0x20);     //raw_noise_base_dummy                                                           
 SP2529MIPI_write_cmos_sensor(0x81,0x30);     //raw_noise_base_low                                                             
 SP2529MIPI_write_cmos_sensor(0x7c,0xff);     //raw_noise_base_dark                                                            
 SP2529MIPI_write_cmos_sensor(0x82,0x68);     //SP2529MIPI_write_cmos_sensor(raw_dns_fac_outdoor,raw_dns_fac_normal}                                       
 SP2529MIPI_write_cmos_sensor(0x83,0x48);     //SP2529MIPI_write_cmos_sensor(raw_dns_fac_dummy,raw_dns_fac_low}                                            
...
//Gamma                                                                                            
SP2529MIPI_write_cmos_sensor(0xfd,0x01);//0x01;gamma                                                                  
SP2529MIPI_write_cmos_sensor(0x8b,0x00);//0x00;                                                                    
SP2529MIPI_write_cmos_sensor(0x8c,0x09);//0x0e;                                                                    
SP2529MIPI_write_cmos_sensor(0x8d,0x15);//0x21;                                                                    
SP2529MIPI_write_cmos_sensor(0x8e,0x1f);//0x2c;                                                                    
SP2529MIPI_write_cmos_sensor(0x8f,0x2a);//0x37;                                                                    
SP2529MIPI_write_cmos_sensor(0x90,0x3e);//0x49;                                                                    
SP2529MIPI_write_cmos_sensor(0x91,0x4f);//0x5c;                                                                    
SP2529MIPI_write_cmos_sensor(0x92,0x5d);//0x67;                                                                    
SP2529MIPI_write_cmos_sensor(0x93,0x68);//0x73;                                                                    
SP2529MIPI_write_cmos_sensor(0x94,0x7c);//0x89;                                                                    
SP2529MIPI_write_cmos_sensor(0x95,0x8b);//0x98;                                                                    
SP2529MIPI_write_cmos_sensor(0x96,0x99);//0xa8;                                                                    
SP2529MIPI_write_cmos_sensor(0x97,0xa6);//0xb5;                                                                    
SP2529MIPI_write_cmos_sensor(0x98,0xb2);//0xc1;                                                                    
SP2529MIPI_write_cmos_sensor(0x99,0xbd);//0xcb;                                                                    
SP2529MIPI_write_cmos_sensor(0x9a,0xc8);//0xd4;                                                                    
SP2529MIPI_write_cmos_sensor(0x9b,0xd2);//0xdc;                                                                    
SP2529MIPI_write_cmos_sensor(0x9c,0xdc);//0xe4;                                                                    
SP2529MIPI_write_cmos_sensor(0x9d,0xe5);//0xeb;                                                                    
SP2529MIPI_write_cmos_sensor(0x9e,0xee);//0xf2;                                                                    
SP2529MIPI_write_cmos_sensor(0x9f,0xf7);//0xf9;                                                                    
SP2529MIPI_write_cmos_sensor(0xa0,0xff);//0xff;                                                                    
                                                                                                
//CCM                                                                                              
SP2529MIPI_write_cmos_sensor(0xfd,0x02);                                                                                     
SP2529MIPI_write_cmos_sensor(0x15,0xa8);                                                                                     
SP2529MIPI_write_cmos_sensor(0x16,0x95);                                                                                     
//!F                                                                                             
SP2529MIPI_write_cmos_sensor(0xa0,0x80);//8c                                                                         
SP2529MIPI_write_cmos_sensor(0xa1,0xf4);//fa                                                                         
SP2529MIPI_write_cmos_sensor(0xa2,0x0c);//fa                                                                         
SP2529MIPI_write_cmos_sensor(0xa3,0xe7);//ed                                                                         
SP2529MIPI_write_cmos_sensor(0xa4,0x99);//a6                                                                         
SP2529MIPI_write_cmos_sensor(0xa5,0x00);//ed                                                                         
SP2529MIPI_write_cmos_sensor(0xa6,0xf4);//e7                                                                         
SP2529MIPI_write_cmos_sensor(0xa7,0xda);//f4                                                                         
SP2529MIPI_write_cmos_sensor(0xa8,0xb3);//a6                                                                         
SP2529MIPI_write_cmos_sensor(0xa9,0x0c);//3c                                                                         
SP2529MIPI_write_cmos_sensor(0xaa,0x03);//33                                                                         
SP2529MIPI_write_cmos_sensor(0xab,0x0f);//0f                                                                         
//F                                                                                          
SP2529MIPI_write_cmos_sensor(0xac,0x86);//0x8c                                                                                  
SP2529MIPI_write_cmos_sensor(0xad,0x00);//0xf4                                                                                  
SP2529MIPI_write_cmos_sensor(0xae,0xfa);//0x00                                                                                  
SP2529MIPI_write_cmos_sensor(0xaf,0xfa);//0xe7                                                                                  
SP2529MIPI_write_cmos_sensor(0xb0,0x93);//0xc0                                                                                  
SP2529MIPI_write_cmos_sensor(0xb1,0xf4);//0xda                                                                                  
SP2529MIPI_write_cmos_sensor(0xb2,0xed);//0xf4                                                                                  
SP2529MIPI_write_cmos_sensor(0xb3,0xc7);//0xcd                                                                                  
SP2529MIPI_write_cmos_sensor(0xb4,0xcc);//0xc0                                                                                  
SP2529MIPI_write_cmos_sensor(0xb5,0x30);//0x0c                                                                                  
SP2529MIPI_write_cmos_sensor(0xb6,0x33);//0x33                                                                                  
SP2529MIPI_write_cmos_sensor(0xb7,0x0f);//0x0f                                                                                  
                                                                                          
SP2529MIPI_write_cmos_sensor(0xfd,0x01);//auto_sat                                                                 
SP2529MIPI_write_cmos_sensor(0xd2,0x2f);//autosa_en[0]                                                             
...
//sat u                                                                                            
SP2529MIPI_write_cmos_sensor(0xfd,0x01);                                                                                     
SP2529MIPI_write_cmos_sensor(0xd3,SP2529_P1_Reg0xd3);//0x70  sp_cm1009                                                                                
SP2529MIPI_write_cmos_sensor(0xd4,SP2529_P1_Reg0xd4);//0x70  sp_cm1009                                                                                   
SP2529MIPI_write_cmos_sensor(0xd5,SP2529_P1_Reg0xd5);//0x70  sp_cm1009                                                                                   
SP2529MIPI_write_cmos_sensor(0xd6,SP2529_P1_Reg0xd6);                                                                                     
//sat v                                                                                           
SP2529MIPI_write_cmos_sensor(0xd7,SP2529_P1_Reg0xd7);//0x70 sp_cm1009                                                                                   
SP2529MIPI_write_cmos_sensor(0xd8,SP2529_P1_Reg0xd8);//0x70 sp_cm1009                                                                                   
SP2529MIPI_write_cmos_sensor(0xd9,SP2529_P1_Reg0xd9);//0x70 sp_cm1009                                                                                   
SP2529MIPI_write_cmos_sensor(0xda,SP2529_P1_Reg0xda);                                                                                    
                                                                                   
SP2529MIPI_write_cmos_sensor(0xfd,0x03);                                                                                     
SP2529MIPI_write_cmos_sensor(0x76,0x10);                                                                                     
SP2529MIPI_write_cmos_sensor(0x7a,0x40);                                                                                     
SP2529MIPI_write_cmos_sensor(0x7b,0x40);                                                                                     
//auto_sat                                                                                        
SP2529MIPI_write_cmos_sensor(0xfd,0x01);                                                                                    
SP2529MIPI_write_cmos_sensor(0xc2,0xff);//aa ;u_v_th_outdoor白色物体表面有彩色噪声降低此值                                       
SP2529MIPI_write_cmos_sensor(0xc3,0xff);//aa ;u_v_th_nr                                                                          
SP2529MIPI_write_cmos_sensor(0xc4,0xaa);//44 ;u_v_th_dummy                                                                       
SP2529MIPI_write_cmos_sensor(0xc5,0xaa);//44 ;u_v_th_low                                                                      
...
//gw                                                                                               
 SP2529MIPI_write_cmos_sensor(0xfd,0x02);
 SP2529MIPI_write_cmos_sensor(0x30,0x20);
 SP2529MIPI_write_cmos_sensor(0x35,0x6f);//uv_fix_dat                                                                            
...
SP2529MIPI_write_cmos_sensor(0x10,SP2529_P1_Reg0x10);//ku_outdoor                                                                          
SP2529MIPI_write_cmos_sensor(0x11,SP2529_P1_Reg0x11);//ku_nr
SP2529MIPI_write_cmos_sensor(0x12,SP2529_P1_Reg0x12);//ku_dummy
SP2529MIPI_write_cmos_sensor(0x13,SP2529_P1_Reg0x13);//ku_low 
SP2529MIPI_write_cmos_sensor(0x14,SP2529_P1_Reg0x14);//kl_outdoor                                                                           
SP2529MIPI_write_cmos_sensor(0x15,SP2529_P1_Reg0x15);//kl_nr                                                                           
SP2529MIPI_write_cmos_sensor(0x16,SP2529_P1_Reg0x16);//kl_dummy                                                                      
SP2529MIPI_write_cmos_sensor(0x17,SP2529_P1_Reg0x17);//kl_low                                                                                           
...
SP2529MIPI_write_cmos_sensor(0x8e,0x0a);//cnr_uv_grad_thr                
SP2529MIPI_write_cmos_sensor(0x8f,0x03);//[0]0 vertical,1 horizontal
SP2529MIPI_write_cmos_sensor(0x90,0x40);//cnrH_thr_outdoor   
SP2529MIPI_write_cmos_sensor(0x91,0x40);//cnrH_thr_nr        
SP2529MIPI_write_cmos_sensor(0x92,0x60);//cnrH_thr_dummy     
SP2529MIPI_write_cmos_sensor(0x93,0x80);//cnrH_thr_low 
SP2529MIPI_write_cmos_sensor(0x94,0x80);//cnrV_thr_outdoor
SP2529MIPI_write_cmos_sensor(0x95,0x80);//cnrV_thr_nr     
SP2529MIPI_write_cmos_sensor(0x96,0x80);//cnrV_thr_dummy  
SP2529MIPI_write_cmos_sensor(0x97,0x80);//cnrV_thr_low

SP2529MIPI_write_cmos_sensor(0x98,0x80);//cnr_grad_thr_outdoor                  
SP2529MIPI_write_cmos_sensor(0x99,0x80);//cnr_grad_thr_nr                  
SP2529MIPI_write_cmos_sensor(0x9a,0x80);//cnr_grad_thr_dummy                  
SP2529MIPI_write_cmos_sensor(0x9b,0x80);//cnr_grad_thr_low                  
...
SP2529MIPI_write_cmos_sensor(0x9f,0x44);                                                                                   
 ...
 SP2529MIPI_write_cmos_sensor(0xfb,0x21);                                                                                             
 SP2529MIPI_write_cmos_sensor(0x32,0x15);//ae en                                                                            
 SP2529MIPI_write_cmos_sensor(0x33,0xef);//ef		//lsc\bpc en                                                       
 SP2529MIPI_write_cmos_sensor(0x34,0xef);		//ynr[4]\cnr[0]\gamma[2]\colo[1]                                           
 SP2529MIPI_write_cmos_sensor(0x35,0x40);		//YUYV                                                                     
 SP2529MIPI_write_cmos_sensor(0xfd,0x00);		                                                                            
//SP2529MIPI_write_cmos_sensor(0x31,0x00);		//size                                                                     
 SP2529MIPI_write_cmos_sensor(0x3f,0x03); 	//mirror/flip                                                                      
...
void SP2529MIPI_night_mode(kal_bool enable)
{
			...
			return;
#endif
 	if(SP2529_SEN_RUN_TEST_PATTERN == 1)
		return;
	//kal_uint16 night = SP2529MIPI_read_cmos_sensor(0x20);
...
static kal_uint32 SP2529MIPI_GetSensorID(kal_uint32 *sensorID)
{
 ...
 s_DEVINFO_ccm =(struct devinfo_struct*) kmalloc(sizeof(struct devinfo_struct), GFP_KERNEL);	
	...
	s_DEVINFO_ccm->device_module = "GCDF130940R";//can change if got module id
	s_DEVINFO_ccm->device_vendor = "GuangZhen";
...
BOOL SP2529MIPI_set_param_effect(UINT16 para)
{
	...
	//	  return TRUE;
	   SENSORDB("[Enter]SP2529mipi_yuv set_param_effect func:para = %d\n",para);
...
BOOL SP2529MIPI_set_param_stauration(UINT16 para)
{
	/*----------------------------------------------------------------*/
	   /* Local Variables												 */
	   /*----------------------------------------------------------------*/
	   ...
	   SENSORDB("[Enter]SP2529mipi_yuv set_param_saturation func:para = %d\n",para);

	   switch (para)
	   {
		   case ISP_SAT_LOW:
			   SP2529MIPI_write_cmos_sensor(0xfd,0x01);
			   SP2529MIPI_write_cmos_sensor(0xd3,SP2529_P1_Reg0xd3-0x28);
			   SP2529MIPI_write_cmos_sensor(0xd4,SP2529_P1_Reg0xd4-0x28);
			   SP2529MIPI_write_cmos_sensor(0xd5,SP2529_P1_Reg0xd5-0x28);
			   SP2529MIPI_write_cmos_sensor(0xd6,SP2529_P1_Reg0xd6-0x28);
			   SP2529MIPI_write_cmos_sensor(0xd7,SP2529_P1_Reg0xd7-0x28);
			   SP2529MIPI_write_cmos_sensor(0xd8,SP2529_P1_Reg0xd8-0x28);
			   SP2529MIPI_write_cmos_sensor(0xd9,SP2529_P1_Reg0xd9-0x28);
			   SP2529MIPI_write_cmos_sensor(0xda,SP2529_P1_Reg0xda-0x28);
			   break;

			 case ISP_SAT_MIDDLE:
			 SP2529MIPI_write_cmos_sensor(0xfd,0x01);                                                                                     
			 SP2529MIPI_write_cmos_sensor(0xd3,SP2529_P1_Reg0xd3);
			 SP2529MIPI_write_cmos_sensor(0xd4,SP2529_P1_Reg0xd4);
			 SP2529MIPI_write_cmos_sensor(0xd5,SP2529_P1_Reg0xd5);
			 SP2529MIPI_write_cmos_sensor(0xd6,SP2529_P1_Reg0xd6);
			 SP2529MIPI_write_cmos_sensor(0xd7,SP2529_P1_Reg0xd7);
			 SP2529MIPI_write_cmos_sensor(0xd8,SP2529_P1_Reg0xd8);
			 SP2529MIPI_write_cmos_sensor(0xd9,SP2529_P1_Reg0xd9);
			 SP2529MIPI_write_cmos_sensor(0xda,SP2529_P1_Reg0xda);
				   break;
	   ...
	   spin_lock(&SP2529mipi_yuv_drv_lock);
	   SP2529MIPICurrentStatus.isaturation = para;
	   spin_unlock(&SP2529mipi_yuv_drv_lock);
	   return ret;
} 

BOOL SP2529MIPI_set_param_contrast(UINT16 para)
{
	/*----------------------------------------------------------------*/
	   /* Local Variables												 */
	   /*----------------------------------------------------------------*/
	   ...
	   SENSORDB("[Enter]SP2529mipi_yuv set_param_contrast func:para = %d\n",para);

	   switch (para)
	   {
		   case ISP_CONTRAST_LOW:
		SP2529MIPI_write_cmos_sensor(0xfd,0x01);
		SP2529MIPI_write_cmos_sensor(0x10,SP2529_P1_Reg0x10-0x28);
		SP2529MIPI_write_cmos_sensor(0x11,SP2529_P1_Reg0x11-0x28);
		SP2529MIPI_write_cmos_sensor(0x12,SP2529_P1_Reg0x12-0x28);
		SP2529MIPI_write_cmos_sensor(0x13,SP2529_P1_Reg0x13-0x28);
		SP2529MIPI_write_cmos_sensor(0x14,SP2529_P1_Reg0x14-0x28);
		SP2529MIPI_write_cmos_sensor(0x15,SP2529_P1_Reg0x15-0x28);
		SP2529MIPI_write_cmos_sensor(0x16,SP2529_P1_Reg0x16-0x28);
		SP2529MIPI_write_cmos_sensor(0x17,SP2529_P1_Reg0x17-0x28); 
			   break;

		 case ISP_CONTRAST_MIDDLE:
		SP2529MIPI_write_cmos_sensor(0xfd,0x01);
		SP2529MIPI_write_cmos_sensor(0x10,SP2529_P1_Reg0x10);
		SP2529MIPI_write_cmos_sensor(0x11,SP2529_P1_Reg0x11);
		SP2529MIPI_write_cmos_sensor(0x12,SP2529_P1_Reg0x12);
		SP2529MIPI_write_cmos_sensor(0x13,SP2529_P1_Reg0x13);
		SP2529MIPI_write_cmos_sensor(0x14,SP2529_P1_Reg0x14);
		SP2529MIPI_write_cmos_sensor(0x15,SP2529_P1_Reg0x15);
		SP2529MIPI_write_cmos_sensor(0x16,SP2529_P1_Reg0x16);
		SP2529MIPI_write_cmos_sensor(0x17,SP2529_P1_Reg0x17); 
			   break;
	   ...
	   spin_lock(&SP2529mipi_yuv_drv_lock);
	   SP2529MIPICurrentStatus.icontrast = para;
	   spin_unlock(&SP2529mipi_yuv_drv_lock);
	   return ret;
} 
BOOL SP2529MIPI_set_param_brightness(UINT16 para)
{
	/*----------------------------------------------------------------*/
	   /* Local Variables												 */
	   /*----------------------------------------------------------------*/
	   ...
	   SENSORDB("[Enter]SP2529mipi_yuv set_param_brightness func:para = %d\n",para);

	   switch (para)
	   {
		   case ISP_BRIGHT_LOW:
				SP2529MIPI_write_cmos_sensor(0xfd,0x01);
				SP2529MIPI_write_cmos_sensor(0xeb,SP2529_P1_Reg0xeb-0x20);
				SP2529MIPI_write_cmos_sensor(0xec,SP2529_P1_Reg0xec-0x20); //target_indr
			    break;
		   case ISP_BRIGHT_MIDDLE:
				SP2529MIPI_write_cmos_sensor(0xfd,0x01);
				SP2529MIPI_write_cmos_sensor(0xeb,SP2529_P1_Reg0xeb);
				SP2529MIPI_write_cmos_sensor(0xec,SP2529_P1_Reg0xec); //target_indr
			    break;
	   ...
	   spin_lock(&SP2529mipi_yuv_drv_lock);
	   SP2529MIPICurrentStatus.ibrightness = para;
	   spin_unlock(&SP2529mipi_yuv_drv_lock);
	   return ret;
} 
...
BOOL SP2529MIPI_set_param_exposure(UINT16 para)
{
	...
	SENSORDB("[Enter]SP2529mipi_yuv set_param_exposure func:para = %d\n",para);
...
UINT32 SP2529MIPIYUVSensorSetting(FEATURE_ID iCmd, UINT16 iPara)
{
	...
	case FID_ISP_CONTRAST:  	    
         SP2529MIPI_set_param_contrast(iPara);
		 break;
	case FID_ISP_SAT:  	    
         SP2529MIPI_set_param_stauration(iPara);
		 break;
	case FID_ISP_BRIGHT:  	    
         SP2529MIPI_set_param_brightness(iPara);
	     break;
...
UINT32 SP2529SetTestPatternMode(kal_bool bEnable)
{
	SP2529_SEN_RUN_TEST_PATTERN = 1;
    //output color bar
	SP2529MIPI_write_cmos_sensor(0xfd,0x01);
	SP2529MIPI_write_cmos_sensor(0x33,0x0f);//add
	SP2529MIPI_write_cmos_sensor(0x34,0x00);//add
	SP2529MIPI_write_cmos_sensor(0x36,0x02);
	SP2529MIPI_write_cmos_sensor(0xfd,0x00);
	SP2529MIPI_write_cmos_sensor(0x1d,0x00);
	SP2529MIPI_write_cmos_sensor(0x1c,0x1f);
	SP2529MIPI_write_cmos_sensor(0x30,0x40);
	SP2529MIPI_write_cmos_sensor(0x1b,0x30);
	SP2529MIPI_write_cmos_sensor(0x0a,0x50);
	SP2529MIPI_write_cmos_sensor(0xfd,0x02);
	SP2529MIPI_write_cmos_sensor(0xdd,0x00);//add
	SP2529MIPI_write_cmos_sensor(0xde,0x00);//add
	SP2529MIPI_write_cmos_sensor(0x88,0x00);
	SP2529MIPI_write_cmos_sensor(0x89,0x66);
	SP2529MIPI_write_cmos_sensor(0x8a,0x22);
	SP2529MIPI_write_cmos_sensor(0xfd,0x01);
	SP2529MIPI_write_cmos_sensor(0xf2,0x0a);
	SP2529MIPI_write_cmos_sensor(0xfb,0x00);//21//modify
	SP2529MIPI_write_cmos_sensor(0xd2,0x00);//3f//modify
	//add satu
	SP2529MIPI_write_cmos_sensor(0xd3,0x60);
	SP2529MIPI_write_cmos_sensor(0xd4,0x60);
	SP2529MIPI_write_cmos_sensor(0xd5,0x60);
	SP2529MIPI_write_cmos_sensor(0xd6,0x60);
		                         
	SP2529MIPI_write_cmos_sensor(0xd7,0x60);
	SP2529MIPI_write_cmos_sensor(0xd8,0x60);
	SP2529MIPI_write_cmos_sensor(0xd9,0x60);
	SP2529MIPI_write_cmos_sensor(0xda,0x60);
	//add  heq
	SP2529MIPI_write_cmos_sensor(0x10,0x80);
	SP2529MIPI_write_cmos_sensor(0x11,0x80);
	SP2529MIPI_write_cmos_sensor(0x12,0x80);
	SP2529MIPI_write_cmos_sensor(0x13,0x80);
	SP2529MIPI_write_cmos_sensor(0x14,0x80);
	SP2529MIPI_write_cmos_sensor(0x15,0x80);
	SP2529MIPI_write_cmos_sensor(0x16,0x80);
	SP2529MIPI_write_cmos_sensor(0x17,0x80);

	SP2529MIPI_write_cmos_sensor(0x00,0x12);
	SP2529MIPI_write_cmos_sensor(0x32,0xc0);//0xd5 //modify c0
	//add awb
	SP2529MIPI_write_cmos_sensor(0xfd,0x02);
	SP2529MIPI_write_cmos_sensor(0x26,0x80);
	SP2529MIPI_write_cmos_sensor(0x27,0x80);
...
static UINT32 SP2529GetExposureTime(void)
{
	...
	high_exp =  SP2529MIPI_read_cmos_sensor(0x03);
	low_exp = SP2529MIPI_read_cmos_sensor(0x04);
	
	SP2529MIPI_write_cmos_sensor(0xfd, 0x01);
	
	high_base = SP2529MIPI_read_cmos_sensor(0xf0);
	low_base = SP2529MIPI_read_cmos_sensor(0xf7);
...
void SP2529MIPIGetExifInfo(UINT32 exifAddr)
{
    ...
    pExifInfo->CapExposureTime = SP2529GetExposureTime();
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_SET_TEST_PATTERN: //for ata test
			SP2529SetTestPatternMode((BOOL) *pFeatureData16);//(kal_bool bEnable)
			break;
		case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE:
			   *pFeatureReturnPara32 = SP2529_TEST_PATTERN_CHECKSUM;
			   *pFeatureParaLen=4;
			   break;	
