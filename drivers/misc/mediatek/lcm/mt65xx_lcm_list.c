...
extern LCM_DRIVER nt35521_hd720_dsi_video_boe_lcm_drv;//add by caozhg
extern LCM_DRIVER otm1283a_hd720_dsi_vdo_tianma_lcm_drv;//add by caozhg
extern LCM_DRIVER hx8394d_hd720_dsi_vdo_yassy_lcm_drv;//add by caozhg
extern LCM_DRIVER dummy_lcm_drv; //caozhg add
...
{ 
#if defined(NT35521_HD720_DSI_VIDEO_BOE)
  &nt35521_hd720_dsi_video_boe_lcm_drv,
#endif

#if defined(OTM1283A_HD720_DSI_VDO_TIANMA)
	&otm1283a_hd720_dsi_vdo_tianma_lcm_drv,
#endif

#if defined(HX8394D_HD720_DSI_VDO_YASSY)
  &hx8394d_hd720_dsi_vdo_yassy_lcm_drv,
#endif
